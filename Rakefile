...
task :spec do
  sh 'xcodebuild -workspace XNGAPIClient.xcworkspace -scheme \'Example\' -destination platform=\'iOS Simulator\',OS=$OS,name=\'iPhone Retina (4-inch)\' test -sdk iphonesimulator | xcpretty -tc'
end
