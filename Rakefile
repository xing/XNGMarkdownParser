...
desc "Runs the specs"
task :spec do
  sh 'xcodebuild -workspace XNGMarkdownParser.xcworkspace -derivedDataPath "./build" -scheme \'Example\' -destination platform=\'iOS Simulator\',OS=9.2,name=\'iPhone 5s\' test -sdk iphonesimulator9.2 | xcpretty -tc && exit ${PIPESTATUS[0]}'
end
