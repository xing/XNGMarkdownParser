...
task :spec do
  sh 'xcodebuild -workspace XNGMarkdownParser.xcworkspace -scheme \'ExampleTests\' -destination platform=\'iOS Simulator\',OS=7.1,name=\'iPhone Retina (4-inch)\' test -sdk iphonesimulator | xcpretty -tc'
end
